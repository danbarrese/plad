...
End Function ''}}}','function ${1:Fun}(${2})
    ...
    ${3://}
}','','','def ${1:fun}(${2}): ${3:ReturnType} = {
    ${4}
}','','','','fn','','fn','function','new function','2014-03-29 05:14:28.937565','2014-09-26 21:36:57.126307','');
...
INSERT INTO "snippets" VALUES(520,'false','','$false','','','False','false','false','false','','','false','','false','','fa','F','-','keyword','false value','2014-03-29 05:14:29.042576','2014-09-26 20:49:32.110746','');
...
INSERT INTO "snippets" VALUES(526,'true','','$true','','','True','true','true','true','','','true','','true','','tr','T','-','keyword','true value','2014-03-29 05:14:29.078841','2014-09-26 20:49:26.925869','');
...
INSERT INTO "snippets" VALUES(568,'&& ','','-and ','And ','&& ','and ','&& ','&& ','&& ','','','&&','','&& ','','and','','-','operator','and, conjunction','2014-03-29 05:14:29.303310','2014-09-26 20:51:10.650648','');
INSERT INTO "snippets" VALUES(569,'@@$(()) (()) ()
== 
@@[] [[]]
-eq','','-eq ','= ','== ','== ','== ','=== ','== ','','','==','','== ','','e','','-','operator','equals','2014-03-29 05:14:29.309807','2014-09-26 20:49:44.117965','');
...
> 
@@[] [[]]
-gt','','-gt ','> ','> ','> ','> ','> ','> ','','','>','','> ','','gt','','-','operator','greater than','2014-03-29 05:14:29.320601','2014-09-26 20:50:11.861143','');
INSERT INTO "snippets" VALUES(572,'@@$(()) (()) ()
>= 
@@[] [[]]
-ge','','-ge ','>= ','>= ','>= ','>= ','>= ','>= ','','','>=','','>= ','','gte','','-','operator','greather than or equal to','2014-03-29 05:14:29.326997','2014-09-26 20:49:58.975436','');
INSERT INTO "snippets" VALUES(573,'@@$(()) (()) ()
< 
@@[] [[]]
-lt','','-lt ','< ','< ','< ','< ','< ','< ','','','<','','< ','','lt','','-','operator','less than','2014-03-29 05:14:29.332635','2014-09-26 20:50:20.306917','');
INSERT INTO "snippets" VALUES(574,'@@$(()) (()) ()
<= 
@@[] [[]]
-le','','-le ','<= ','<= ','<= ','<= ','<= ','<= ','','','<=','','<= ','','lte','','-','operator','less than or equal to','2014-03-29 05:14:29.337588','2014-09-26 20:50:25.397371','');
...
INSERT INTO "snippets" VALUES(577,'!= ','','-ne ','<> ','!= ','!= ','!= ','!== ','!= ','','','!=','','!= ','','ne','','-','operator','not equals','2014-03-29 05:14:29.354186','2014-09-26 20:49:38.952766','');
...
INSERT INTO "snippets" VALUES(580,'|| ','','-or ','Or ','|| ','or ','|| ','|| ','|| ','','','||','','|| ','','or','','-','operator','or, disjunction','2014-03-29 05:14:29.370051','2014-09-26 20:51:23.151787','');
...
INSERT INTO "snippets" VALUES(640,'${1:boolvar}=${2:true}','','','xDim b_${1}: b_$1 = ${2:True}','','${1:b} = ${2:true}','boolean ${1:b} = ${2:false};','','','','','def ${1:var}: Boolean = ${2:true}','','','','vb','','v','variable','boolean','2014-03-29 05:14:29.683619','2014-09-26 20:35:20.590641','');
...
INSERT INTO "snippets" VALUES(644,'${1:floatvar}=0.00','','','xDim d_${1}: d_$1 = ${2:0.0}','','@LINK{vv}','double ${1:d} = ${2:1.0};','','','','','def ${1:var}: Double = ${2:1.0}','','@LINK{vv}','','vd','','v','variable','double','2014-03-29 05:14:29.706154','2014-09-26 20:35:40.774498','');
...
INSERT INTO "snippets" VALUES(650,'declare -i ${1:i}=0','','','xDim i_${1}: i_$1 = ${2:0}','','@LINK{vv}','int ${1:i} = ${2:1};','','','','','def ${1:var}: Int = ${2:1}','','@LINK{vv}','','vi','','v','variable','integer','2014-03-29 05:14:29.738883','2014-09-26 20:36:09.724727','');
...
INSERT INTO "snippets" VALUES(659,'','','','','','','NO','','','','','${1}: => ${2:Int}','','','','vref','','v','variable','reference, pointer','2014-03-29 05:14:29.787282','2014-09-26 20:32:08.557835','');
...
INSERT INTO "snippets" VALUES(666,'${1:foo}=${2:val}','','$${1:foo} = ${2:val}','Dim ${1}','','${1:foo} = ${2}','${1:Object} ${2:o} = new $1();','var ${1:foo} = ${2}','','','','def ${1:var}: ${2:Type} = ${val}','','${1:foo} = ${2}','','vv','','v','variable','dynamic type declaration','2014-03-29 05:14:29.825418','2014-09-26 20:34:19.275989','');
